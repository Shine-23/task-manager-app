...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT new com.example.task_manager_app.dto.UserDTO(u.id, u.username) " +
    ...
    @Query("SELECT new com.example.task_manager_app.dto.UserDTO(u.id, u.username) FROM User u")
    Page<UserDTO> findAllUsers(Pageable pageable);

    @Query("SELECT new com.example.task_manager_app.dto.UserDTO(u.id, u.username, u.email) " +
